...
if not TOKEN_AVAILABLE:
    ...
    try:
        ...
        test_kerberos_tokens = str(get_auth_backend().get_token(test_username))
        TOKEN_AVAILABLE = True
    except Exception:
        pass
...
class TestServiceAPI:
    ...
    # NOTE: /api/v2/service/access_shared_rootfile is temporarily disabled
    # (route commented out in service_manager.py), so this test is disabled too.
    # Re-enable together with the route and its whitelist entries.
