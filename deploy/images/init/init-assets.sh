...
if [[ "$FASTINK_ENABLE_HOST_SLURM_CLIENT" == "true" ]]; then
  upsert_named_entry slurm /work/etc-init/passwd "slurm:x:58002:58002:Slurm workload manager:/var/lib/slurm:/sbin/nologin"
  upsert_named_entry slurm /work/etc-init/group "slurm:x:58002:"
  upsert_named_entry slurm /work/etc-init/shadow "slurm:!!:20460::::::"
  upsert_named_entry slurm /work/etc-init/gshadow "slurm:!::"
fi
