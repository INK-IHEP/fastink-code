...
COMMON_DEFAULTS = {
    ...
    "nginx_cors_origins": "",
    # DNS suffix appended to bare node names (nginx upstreams and job
    # listings), e.g. ".example.org". Empty = no suffix.
    "node_domain_suffix": "",
    # CVMFS paths warmed by the host precheck; empty = built-in defaults.
    "cvmfs_required_paths": [],
}
