...
from fastink.computing.tools.db.db_tools import insert_job_info
from fastink.computing.site.strategy import get_site, get_submitter
from fastink.computing.job_defaults import SLURM_JOB_DEFAULTS
...
async def create_job(
    ...
    defaults = SLURM_JOB_DEFAULTS.get(job_type)
    if defaults:
        script_file = defaults["script_file"]
    ...
    parameters = f" --comment={job_type} --wckey={job_type} "
