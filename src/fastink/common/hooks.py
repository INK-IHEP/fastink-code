...
def get_hook(hook_name: str, default_func: Optional[Callable] = None) -> Callable:
    ...
    Args:
        ...
        default_func: Default function to return if hook is not registered
...
def hookable(default_func: Callable) -> Callable:
    ...
    def wrapper(*args, **kwargs):
        # Get the hook for this function, falling back to default
        hooked_func = get_hook(hook_name, default_func)
