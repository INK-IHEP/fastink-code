...
from fastink.common.utils import generate_uuid
from fastink.database.sqla.types import GUID
...
class ExternalIdentities(BASE, ModelBase):
    ...
    __table_args__ = (
        UniqueConstraint(
            "issuer", "subject", name="EXTERNAL_IDENTITIES_ISS_SUB_UQ"
        ),
        ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="EXTERNAL_IDENTITIES_USER_FK"
        ),
        Index("EXTERNAL_IDENTITIES_ISS_SUB_IDX", "issuer", "subject"),
