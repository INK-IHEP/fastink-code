...
> Deprecated: user, permission, and group management has moved to the `/api/v2/admin` endpoints and `fastink-cli`. This `ink` command is retained for in-container emergency use only.
...
# Add a new user
ink user add --username=testuser --uid=12345

# Update user information
ink user update --username=testuser --new-username=newuser --new-uid=54321

# Delete a user
ink user delete --username=testuser --uid=12345
...
```bash
pip install -e /path/to/fastink-code
```
